...
//=================================================================
//  File:		DataManagerEditors.cs
//
//  Namespace:	DataVisualization.Charting.Design
//
//	Classes:	SeriesAreaNameConverter, ChartTypeEditor, 
//				ChartTypeConverter, SeriesNameConverter, 
//				UrlValueEditor, AngleValueEditor, AngleTrackForm,
//				NoNameExpandableObjectConverter, DoubleArrayConverter,
//				DataPointValueConverter, DataPointCollectionEditor, 
//				ChartCollectionEditor, SeriesCollectionEditor, 
//				SeriesYValueTypeConverter
//
